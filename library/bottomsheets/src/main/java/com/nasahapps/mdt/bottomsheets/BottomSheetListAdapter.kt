...
class BottomSheetListAdapter(items: List<BottomSheetItem>, dialog: DialogInterface,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BottomSheetAdapter.ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.mdt_list_bottom_sheet_item, parent, false)
