...
public class BottomSheetUtils {
    ...
    public static class DialogBuilder {
        ...
        public DialogBuilder(Context c, boolean isGrid) {
...
//        }
        ...
        public DialogBuilder setItems(@MenuRes int menuRes, BottomSheetAdapter.OnClickListener listener) {
        ...
        public DialogBuilder setItems(List<BottomSheetItem> items, BottomSheetAdapter.OnClickListener listener) {
        ...
        public DialogBuilder setIconTint(@ColorInt int tint) {
            mIconTint = tint;
